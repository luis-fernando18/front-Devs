...
* {
  ...
  input:disabled {
    background-color: #eee(100, 100, 100);
  }
...
<svg class="icone-olho" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    d="M13.875 18.825A10.05 10.05 0 0112 19c-4.477 0-8.268-2.943-9.542-7a10.05 10.05 0 012.153-3.592M6.634 6.634A9.956 9.956 0 0112 5c4.477 0 8.268 2.943 9.542 7-.458 1.459-1.241 2.763-2.247 3.802M15 12a3 3 0 01-3 3m0-6a3 3 0 013 3m-6 0a3 3 0 003-3m0 6v.01" />
...
function verificarForcaSenha(senha) {
  ...
  if (/[@~$!=%*?_&"'-+#¨^:;<>,.{})()]/.test(senha)) forca++;       // caractere especial
